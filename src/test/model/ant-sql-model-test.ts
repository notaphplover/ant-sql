...
export class AntSqlModelTest implements Test {
  ...
  public performTests(): void {
    describe(this._declareName, () => {
      ...
      this._itMustTransformEntityIntoSecondaryWithReferenceField();
      this._itMustTransformMultipleEntityIntoPrimaryWithReferenceField();
      this._itMustTransformMultipleEntityIntoSecondaryWithReferenceField();
  ...
  private _itMustTransformEntityIntoSecondaryWithReferenceField(): void {
    it(
      'must transform an entity with a reference field into a secondary object',
      async (done) => {
        const refTableName = 'RefModelSqlTableName';
        const tableName = 'ModelSqlTableName';
        const refModel = new AntSqlModel(
        ...
        const secondary = model.entityToSecondary(entity);

        expect(secondary.id).toBe(entity.id);
        expect(secondary.number).toBe(entity.number);
        expect(secondary.reference).toBe(entity.reference.id);
        done();
      },
      MAX_SAFE_TIMEOUT,
    );
  ...
  private _itMustTransformMultipleEntityIntoSecondaryWithReferenceField(): void {
    it(
      'must transform multiple entities with a reference field into secondary objects',
      async (done) => {
        const refTableName = 'RefModelSqlTableName';
        const tableName = 'ModelSqlTableName';
        const refModel = new AntSqlModel(
        ...
        const [secondary] = model.mEntityToSecondary([entity]);
  ...
  private _itMustTransformMultiplePrimaryIntoEntityWithReferenceField(): void {
    it(
      ...
      async (done) => {
        ...
        expect((entity.reference as SqlReference<Entity, number>).id).toBe(primary.reference);
  ...
  private _itMustTransformMultipleSecondaryIntoEntityWithReferenceField(): void {
    it(
      ...
      async (done) => {
        ...
        expect((entity.reference as SqlReference<Entity, number>).id).toBe(secondary.reference);
