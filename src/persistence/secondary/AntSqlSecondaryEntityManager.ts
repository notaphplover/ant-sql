...
export class AntSqlSecondaryEntityManager<TEntity extends Entity>
  ...
  public insert(entity: TEntity): Promise<any> {
    let insertionPromise: Promise<any> = this
      ._dbConnection
  ...
  public mInsert(entities: TEntity[]): Promise<any> {
    ...
    let insertionPromise: Promise<any> = this
      ._dbConnection
      .insert(entities.map(
        (entity) => this._helper.buildKnexObject(this.model, entity),
      ))
      .into((this.model.tableName));
